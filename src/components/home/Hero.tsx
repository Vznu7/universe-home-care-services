    ...
    <section className="relative bg-teal-50 pt-6 pb-10 md:pt-10 md:pb-14 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-stretch lg:gap-12">
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0 lg:py-2 flex flex-col justify-center">
            <div className="self-start inline-flex items-center space-x-2 bg-teal-100 text-teal-800 px-2.5 py-1 rounded-full text-xs font-semibold mb-3 lg:mb-4 shadow-sm border border-teal-200">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-teal-500 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-teal-600"></span>
              </span>
              <span>24/7 Home Care Service</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-5xl xl:text-6xl font-bold text-slate-900 leading-tight mb-3 lg:mb-4">
              Compassionate Care,<br />
              <span className="text-teal-700">Right Where You Feel at Home</span>
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-5 lg:mb-6 leading-relaxed max-w-xl">
          ...
          <div className="w-full lg:w-1/2 relative min-h-[320px] lg:min-h-0 mt-6 lg:mt-0">
            <img 
              src="/hero-image.jpg" 
